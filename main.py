...
WIN = pygame.display.set_mode((env.WIDTH, env.WIDTH))
...
class Spot:
    ...
    def is_closed(self):
        return self.color == env.RED

    def is_open(self):
        return self.color == env.GREEN

    def is_barrier(self):
        return self.color == env.BLACK

    def is_start(self):
        return self.color == env.ORANGE

    def is_end(self):
        return self.color == env.TURQUOISE

    def reset(self):
        self.color = env.WHITE

    def make_start(self):
        self.color = env.ORANGE
    ...
    def make_barrier(self):
        self.color = env.BLACK

    def make_end(self):
        self.color = env.TURQUOISE

    def make_path(self):
        self.color = env.PURPLE
...
def draw_grid(win, rows, width):
    gap = width // rows
    for i in range(rows):
        pygame.draw.line(win, env.GREY, (0, i * gap), (width, i * gap))
        for j in range(rows):
            pygame.draw.line(win, env.GREY, (j * gap, 0), (j * gap, width))
